        ...
        <table id="tabela">
            <thread>
                <tr>
                    <th class="top">Typ</th><th class="top">Numer faktury</th> <th class="top">Nazwa kontrahenta</th> <th class="top">NIP</th> <th class="top">Kwota netto</th> <th class="top">VAT</th> <th class="top">Kwota brutto</th> <th class="top">Waluta</th> <th class="top">Kwota netto w walucie</th> <th class="top">Szczegóły</th>
                </tr>
            </thread>
            <tbody>
                <?php
